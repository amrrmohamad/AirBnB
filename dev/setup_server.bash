...
$dir_path="~/github.com/amrmohamad55/AirBnB_clone_v3/"
...
service mysql start
mkdir -p ~/github.com/amrmohamad55/
cd ~/github.com/amrmohamad55/
git clone https://github.com/amrrmohamad/AirBnB_clone_v3.git
cd AirBnB_clone_v3
